...
echo '<h2>Second Example of "b", echoing "1" - what does that mean? 1 equals TRUE ("b" is NULL!)</h2>';
$b = null;
echo "b is " . is_null($b) . "<br>";

echo '<h2>Third Example of "c", ergo, c IS NOT NULL (if "null" is in double quotes, this NOT NULL)</h2>';
$c = "null";
