...
<select name="bank">
<!-- <option value=""  <?php if(isset($_POST['bank']) && $_POST['bank'] == NULL) echo 'selected ="unselected" ' ;?>>Select one!</option> NB! option value="" NULL - does Not like validation!  -->
...
if(empty($_POST['currency'])) {
    ...
    echo '<sp class="error">Please check your currency!</p>';
}
...
<p>You now have  <b>$'.number_format($dollars, 2).' American dollars</b> 
    and we will be emailing you at <b> '.$email.'</b> with your information, 
    as well as depositing your funds at <b>'.$bank.' bank!</b></p>
