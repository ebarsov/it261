...
echo '<h2>Celcious Converter</h2>';

function celcious_converter($cel) {
    $far = ($cel * 9/5) +32;
    echo $far;
}

celcious_converter(100);

echo '<h2>How to do we deal with arrays??? We are going to be using indexed arrays</h2>';
...
/* foreach($nav as $key => $value){
    if(THIS_PAGE == $key) {
    echo '<li><a class ="current" href="'.$key.'">
    '.$value.' </a></li>';
    } else {
