<?php
// this is my server page that will be comminicating to the data base page

// our session - this is where we will start our session - it is a way to store the information
// we would like the information that is inputted via our registeration form to land our database!!!
...
include('config.php');
// we will eventually header include
include('./includes/header.php');

$iConn = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME) or die(myError(__FILE__,__LINE__,mysqli_connect_error()));

// we will be asking if reg_user isset
// we will also be using a new function which is mysqli_real-escape_string
...
// if there is username in our database, the end user cannot use that username
// it there is already an email in our database, the end user cannot use that email
...
// logically - we have to insert the information into database
...
if(isset($_POST['login_user'])) {
    ...
    // we are going to query our users table to make sure that username AND password match
