<?php   // this is our index.php which in the big picture, it represents the home page of a website
...
<header>
<!--if our Session for the username is successfull, we will display a message-->
<?php
