...
$total *= 1.097;
echo $total;
echo '<h3>We would like our amount to reflect 2 decimal places --
 we are thinking about floats and a new function - number_format()</h3>';
...
$fruit[]= 'bananas'; // 0 (number starts with 0)
$fruit[]= 'cherries'; // 1
$fruit[]= 'melon';   // 2
$fruit[]= 'kiwi';    //3
$fruit[]= 'oranges'; // 4
...
echo '<h3>Now we have an assosiative array</h3>';
