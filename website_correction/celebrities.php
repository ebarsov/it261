...
<main>
    <h1>Welcome to Clebrities Page!</h1>
<?php 
...
// we have a row, which translates into array
...
while($row = mysqli_fetch_assoc($result)) {
    ...
    <p>For more information about '.$row['first_name'].', click <a href="celebrities-view.php?id='.$row['celebrities_id'].' ">here</a></p>
    ';
