...
<body>
    <h1><a href= "index.php">Elena's IT 261 Portal Page</a></h1>
    <h2>Welcome</h2>
    <div id="wrapper">
        <nav>
            <ul>
                ...
                <li><a href="./calculator/calculator4.php ">Calculator</a></li>
        ...
        <aside>
            ...
            <ol>
                ...
                <li><a href="weeks/week7/treasure_hunt.php ">treasure_hunt.php</a></li>
            </ol>
...
<footer>
        <ul>
            ...
            <li><a href="../index.php">Web Design by Elena</a></li>
